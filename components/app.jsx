...
function PhoneFrame({ children, android = false }) {
  const t = useTokens();
  const frameBg = t.dark ? "#101010ff" : "#F0EEE9";
...
function App() {
  ...
  useEffectApp(() => {
    document.body.style.background = t.dark ? "#060708" : "#F0EEE9";
    ...
    if (t.dark) {
      el.textContent = `
        [data-dc-canvas]{background:#060708!important}
        .design-canvas{background:#060708!important}
