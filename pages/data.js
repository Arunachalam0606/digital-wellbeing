...
window.APP_DATA = {
  ...
  pickupHours: {
    personal: [
      0, 0, 0, 0, 0, 0, 1, 3, 5, 8, 6, 4, 7, 5, 4, 6, 9, 11, 8, 5, 3, 2, 1, 0,
    ],
    maya: [
      0, 0, 0, 0, 0, 0, 0, 0, 2, 4, 3, 2, 5, 6, 4, 8, 12, 10, 8, 6, 2, 0, 0, 0,
    ],
  },
  ...
  adBlocker: {
    ...
    hourly: [
      12, 8, 5, 3, 4, 14, 48, 142, 268, 312, 388, 410, 426, 388, 342, 298, 311,
      348, 412, 388, 264, 184, 98, 41,
    ],
  },
  ...
  notifications: [
    {
      ...
      kid: "jaden",
      kind: "limit-hit",
      text: "Jaden hit the Snapchat daily limit (60m).",
      icon: "lock",
    },
    {
      time: "18 min ago",
      kid: "maya",
      kind: "warn",
      text: "Maya at 80% of Roblox limit (48/60m).",
      icon: "alert",
    },
    {
      time: "1h ago",
      kid: "jaden",
      kind: "bypass",
      text: "Jaden attempted to reinstall TikTok.",
      icon: "shield",
    },
    {
      time: "3h ago",
      kid: "maya",
      kind: "achieved",
      text: "Maya finished Duolingo daily goal.",
      icon: "check",
    },
    {
      time: "Yesterday",
      kid: "jaden",
      kind: "request",
      text: "Jaden requested 30 more minutes on Discord.",
      icon: "message",
    },
    {
      time: "Yesterday",
      kid: "maya",
      kind: "schedule",
      text: "Weekend schedule activated for Maya.",
      icon: "calendar",
    },
    {
      time: "2 days ago",
      kid: "jaden",
      kind: "limit-hit",
      text: "Jaden hit Instagram limit (45m).",
      icon: "lock",
    },
    {
      time: "2 days ago",
      kid: "maya",
      kind: "achieved",
      text: "Maya stayed under all goals 3 days in a row.",
      icon: "trophy",
    },
  ],
